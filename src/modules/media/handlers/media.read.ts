...
export const mapAsset = (r: any) => {
  ...
  return {
    ...
    // Assets uploaded before the merge carry the old gateway/media-service
    // origin in their stored URL; rewrite it onto the current one.
    url: normaliseMediaUrl(r.url),
