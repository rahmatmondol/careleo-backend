...
export const mediaManageRoutes = (app: Elysia) =>
  app
    .post('/api/v1/media/upload', async ({ request, user, set }) => {
    ...
    .post('/api/v1/media/assets', async ({ body, user, set }) => {
      const b = body as any;
    ...
    .put('/api/v1/media/assets/:id', async ({ params, body, set }) => {
    ...
    .delete('/api/v1/media/assets/:id', async ({ params, set }) => {
    ...
    .post('/api/v1/media/links', async ({ body, user, set }) => {
      const b = body as any;
    ...
    .delete('/api/v1/media/links/:id', async ({ params, set }) => {
    ...
    .delete('/api/v1/media/links/entity/:entityType/:entityId', async ({ params }) => {
